	...
	public void init(Player player, InventoryContents contents) {
		contents.set(1, 3,
				ClickableItem.of(ItemHelper.setDetails(new ItemStack(Material.NETHER_STAR),
						...
						e -> {
							player.sendMessage("" + ChatColor.BOLD + "(!) " + ChatColor.RESET + "You have been sent to "
									+ ChatColor.GREEN + "Super Craft Blocks");
		...
		contents.set(1, 5,
				ClickableItem.of(ItemHelper.setDetails(new ItemStack(Material.IRON_SWORD),
						"" + ChatColor.RESET + ChatColor.GREEN + "Singleplayer Practice",
						"" + ChatColor.GRAY + "Come here to practice & ",
						"" + ChatColor.GRAY + "become a better player!"), e -> {
